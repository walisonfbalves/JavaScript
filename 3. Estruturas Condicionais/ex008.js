...
// Utilizamos o método getMonth() do objeto Date para retornar o mês atual, que vai de 0 á 11
var data_atual = new Date();
var mes_atual = data_atual.getMonth();

// Criamos uma estrutura if capaz de identificar um trimestre apartir do número do mês
